...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <section className="speaker-strip" aria-label="Speakers from leading companies"><p>SPEAKERS FROM</p><div className="speaker-logos"><img src="/images/partners/animoca-brands-new.png" alt="Cursor" /><img src="/images/partners/og-new.png" alt="Naise" /><img src="/images/partners/qwen-provided.png" alt="Qwen" /><img src="/images/partners/ai-collective-new.png" alt="Partner logo" /><img src="/images/partners/speaker-brand-5.png" alt="Speaker brand" /></div></section>
    </section>
