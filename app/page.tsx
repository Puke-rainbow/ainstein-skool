...
export default function Home() {
  return <main>
    ...
    <nav className="nav shell" aria-label="Main navigation"><a href="#top" className="ainstein-logo nav-portrait" aria-label="Ainstein home"><img src="/images/why-ainstein.png" alt="Ainstein hosts" /></a><a href="#top" className="word-logo" aria-label="Ainstein home"><img src="/images/ainstein-word-logo-header.png" alt="Ainstein" /></a><a className="button" href="https://www.ainsteinskool.com/casestudy001">CASE STUDY:</a><CommunityButton>JOIN AINSTEIN</CommunityButton></nav>
