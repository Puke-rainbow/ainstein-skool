...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <section className="speaker-strip" aria-label="Speakers from leading companies"><p>SPEAKERS FROM</p><div className="speaker-logos"><img src="/images/partners/animoca-brands.svg" alt="Animoca Brands" /><img src="/images/partners/ai-collective.png" alt="The AI Collective" /><img src="/images/partners/og.png" alt="OG" /><img className="partner-logo--one" src="/images/partners/partner-logo-1.png" alt="OKX" /><img className="partner-logo--two" src="/images/partners/partner-logo-2.png" alt="Partner company" /><img src="/images/partners/qwen-logo-cropped.png" alt="Qwen" /></div></section>
    </section>
